...
def main() -> None:
    ...
    Examples:
      python scripts/download_kaggle_dataset.py --dataset \
          "kmader/skin-cancer-mnist-ham10000" --out data/kaggle
    """
    p = argparse.ArgumentParser()
    p.add_argument(
        "--dataset",
        required=True,
        help='Kaggle dataset slug like "kmader/skin-cancer-mnist-ham10000"',
    )
